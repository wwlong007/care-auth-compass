package com.careauth.compass.domain.generated.policy;
...
public final class GeneratedPolicyMatrix058 {
    private static final String CODE = "POLICY-058";
    ...
    public List<String> dimensions() {
        return List.of("tenant", "payer", "plan", "procedure", "policy");
    }
